...
>
  <head>
    ...
    <title>Manajemen Lokasi Pengembalian | Driveasy</title>
  ...
  <body>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4">Manajemen Lokasi Pengembalian</h4>

              <!-- Responsive Table -->
              <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                  <h5 class="mb-0">Daftar Lokasi Pengembalian</h5>
                  <button
                    type="button"
                    ...
                    <table id="lokasiTable" class="table table-striped table-hover">
                      ...
                      <tbody>
                        ...
                        $query = "SELECT l.*, COUNT(p.id) as jumlah_peminjaman 
                                  FROM lokasi_pengembalian l 
                                  LEFT JOIN peminjaman p ON l.id = p.pengembalian_id 
                                  GROUP BY l.id 
                                  ORDER BY l.id";
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            echo "<tr><td colspan='4' class='text-center'>Tidak ada data lokasi pengembalian</td></tr>";
                        }
                        ?>
                      </tbody>
                    </table>
            ...
            <div class="modal fade" id="tambahLokasiModal" tabindex="-1" aria-hidden="true">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <form action="process/lokasi_pengembalian_process.php" method="post">
            ...
            <!-- Modal Edit Lokasi Pengembalian -->
            <div class="modal fade" id="editLokasiModal" tabindex="-1" aria-hidden="true">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title">Edit Lokasi Pengembalian</h5>
                    <button
                      type="button"
                      class="btn-close"
                      data-bs-dismiss="modal"
                  ...
                  <form action="process/lokasi_pengembalian_process.php" method="post" id="editLokasiForm">
            ...
            <div class="modal fade" id="deleteLokasiModal" tabindex="-1" aria-hidden="true">
              <div class="modal-dialog modal-sm" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <p id="deleteLokasiText">Apakah Anda yakin ingin menghapus lokasi pengembalian ini?</p>
                  </div>
                  <div class="modal-footer">
                    <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">
                      Batal
    ...
    <script>
      ...
      function editLokasi(id) {
        $.ajax({
          url: 'process/lokasi_pengembalian_process.php',
          type: 'GET',
          data: {
            id: id,
            action: 'get'
      ...
      function deleteLokasi(id, jumlahPeminjaman) {
        ...
        if (jumlahPeminjaman > 0) {
          ...
          $('#deleteLokasiText').html('Apakah Anda yakin ingin menghapus lokasi pengembalian ini?');
        }
