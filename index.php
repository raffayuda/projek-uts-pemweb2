    ...
    <section class="py-12 md:pt-34 md:py-20 relative pt-28">
      <div class="container mx-auto px-6">
        <div class="grid md:grid-cols-2 gap-12 items-center">
          <div class="space-y-6">
            <h1 class="text-4xl md:text-6xl font-bold leading-tight">Drive Your Dreams <?= $isLoggedIn ?  "<button>test</button>" :  '' ?><span class="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-blue-500">Today</span></h1>
          ...
          <form id="booking-form" method="post" action="process_booking.php" enctype="multipart/form-data">
            <div class="form-step">
              ...
              <div class="mt-8 flex justify-end">
                <?php if($isLoggedIn){
                  echo '
                  <button type="button" class="next-step px-8 py-3 bg-gradient-to-r from-purple-600 to-blue-500 rounded-lg hover:opacity-90 transition-opacity font-medium">Next Step</button>
                  ';
                }else{
                  echo '
                  <a href="auth/login.php" class=" px-8 py-3 bg-gradient-to-r from-purple-600 to-blue-500 rounded-lg hover:opacity-90 transition-opacity font-medium">Login</a>
                  ';
                }
                ?>
              </div>
            ...
            <div class="form-step hidden">
              ...
              <div class="mt-8 flex justify-between">
                <button type="button" class="prev-step px-8 py-3 border border-purple-400 rounded-lg hover:bg-purple-400 hover:text-gray-900 transition-colors font-medium">Previous</button>
                <button type="button" class="next-step px-8 py-3 bg-gradient-to-r from-purple-600 to-blue-500 rounded-lg hover:opacity-90 transition-opacity font-medium">Next Step</button>
              </div>
            </div>
            ...
            <div class="form-step hidden">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <p class="mt-1 text-sm text-gray-400">Upload foto KTP yang jelas dan tidak buram</p>
                </div>
                <div>
                ...
                <div class="md:col-span-2">
                  <label class="block mb-2 text-gray-300">Keperluan Pinjaman</label>
                ...
                <div class="md:col-span-2">
                  <label class="block mb-2 text-gray-300">Comments/Special Requests</label>
                  <textarea
                    name="comments"
                    id="comments"
                    ...
                    rows="4"
                    placeholder="Enter any special requests or additional information about your rental needs..."></textarea>
                </div>
                <div class="md:col-span-2">
            ...
            <div class="form-step hidden">
              ...
              <div class="bg-gray-700 bg-opacity-50 rounded-lg p-6 mb-6">
                <div class="flex items-center justify-between mb-4">
                  <h4 class="text-lg font-semibold" id="summary-vehicle-name">Select a vehicle</h4>
              ...
              <div class="mt-8 flex justify-between">
                <button type="button" class="prev-step px-8 py-3 border border-purple-400 rounded-lg hover:bg-purple-400 hover:text-gray-900 transition-colors font-medium">Previous</button>
                <button type="submit" id="complete-booking" class="px-8 py-3 bg-gradient-to-r from-purple-600 to-blue-500 rounded-lg hover:opacity-90 transition-opacity font-medium">Complete Booking</button>
              </div>
            </div>
          </form>
        </div>
